...
const char* FastResearchInterface::GetCompleteRobotStateAndInformation(void)
{
	...
	case FastResearchInterface::JOINT_TORQUE_CONTROL:
		sprintf(StringPart, "Control strategy: Joint torque control (with gravity compensation)");
		break;
	case FastResearchInterface::JOINT_DYNAMIC_CONTROL:
		sprintf(StringPart, "Control strategy: Joint torque control (without gravity compensation)");
		break;
	default:
