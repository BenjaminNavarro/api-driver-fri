...
void* FastResearchInterface::KRCCommunicationThreadMain(void *ObjectPointer)
{
	...
	for(;; )
	{
		...
		if (ThisObject->CurrentControlScheme == FastResearchInterface::JOINT_TORQUE_CONTROL or ThisObject->CurrentControlScheme == FastResearchInterface::JOINT_DYNAMIC_CONTROL)
		{
