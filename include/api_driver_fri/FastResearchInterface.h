...
//  ----------------------------------------------------------
	enum LWRControlModes
	{
		...
		//! \brief Joint torque control (with gravity compensation)
		JOINT_TORQUE_CONTROL    =   40,
		//! \brief Joint torque control (without gravity compensation)
		JOINT_DYNAMIC_CONTROL   =   50
	};
